...
| 版本 | 类型 | 状态 | 说明 |
|---|---|---|---|
| `LEGACY-FE-8083` | 前端保留版本 | 保留使用 | `101.43.49.78:8083`，Vue + Vite 前端入口 |
| `API-CURRENT-0.1` | 当前已落地 API | 可运行 | 当前 FastAPI 最小闭环接口 |
...
| `OPENAPI-8082-CURRENT-2026.05.07` | OpenAPI 快照 | 当前参考 | 文档站发布的 OpenAPI JSON |

## 当前环境

| 内容 | 结论 |
|---|---|
| `101.43.49.78:8083` | 保留为现有 Vue + Vite 前端入口 |
| `101.43.49.78:8082/docs` | 作为当前 API Swagger 参考 |
