---
id: protocol-api-gap-and-supplement
title: 技术协议功能对照与缺口 API 补充文档
slug: /protocol-api-gap-and-supplement
---
...
将软件界面划分为五个一级界面，这个口径应作为后续前端页面拆分和 FastAPI 接口分组的主要依据。
